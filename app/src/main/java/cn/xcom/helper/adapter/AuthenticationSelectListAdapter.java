 ...
 */
public class AuthenticationSelectListAdapter extends BaseAdapter {
    private Context ctx;
    private String[] text;
    private int position = 0;
    private int layout = R.layout.item_authentication_select_list;

    public AuthenticationSelectListAdapter(Context ctx, String[] text) {
        this.ctx = ctx;
        this.text = text;
    }

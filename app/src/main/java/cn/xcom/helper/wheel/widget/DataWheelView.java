package cn.xcom.helper.wheel.widget;
...
public class DataWheelView extends TosGallery {
    /**
     * The selector.
     */
     ...
     * @param defStyle
     */
    public DataWheelView(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * @see com.canyinka.catering.activity.wheel.widget.nj1s.lib.widget.TosGallery#setSelectedPositionInt(int)
     */
    @Override
